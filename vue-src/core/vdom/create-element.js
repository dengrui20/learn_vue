...
export function createElement (
  ...
  /*兼容不传data的情况*/
  // isPrimitive retuen typeof value === 'string' || typeof value === 'number'
  ...
  */
  ...
  if (typeof tag === 'string') {
    ...
    if (config.isReservedTag(tag)) {
      ...
      // 如果tag 是string类型 并且不是保留html标签 则查找对应组件的构造器
      // component 在 $option.components 上查找有没有注册过对应的组件 全局注册的组件通过合并配置也会合并到子组件上
